In order for this server to work properly you must have Node.js installed on your machine. 

If you do not have it installed it can be downloaded here: https://nodejs.org/en/
